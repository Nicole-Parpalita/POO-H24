...
class Employe:
    ...
    def __init__(self, matricule: str = "", nom: str = "", prenom: str = "",
                     annee_naissance: int = 0, salaire_annuel: float = 0.0, annee_entree_fonction: int = 0):
        """
        ...
        self._salaire_annuel = salaire_annuel
        self._annee_entree_fonction = annee_entree_fonction
    ...
    def __str__(self):
        ...
        """
        return (f"\nLe matricule de l'employé     : {self._matricule}\n"
                f"Le nom de l'employé est           : {self._nom}\n"
                f"Le prénom de l'employé est        : {self._prenom}\n"
                f"L'année de naissance de l'employé : {self._annee_naissance}\n"
                f"Le salaire annuel de l'employé    : {self._salaire_annuel}\n"
